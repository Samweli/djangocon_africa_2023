...
def set_date_widgets(
    ...
    date_one = QPushButton('2023-11-08 12:00:00')
    date_two = QPushButton('2023-11-08 15:00:00')
    date_three = QPushButton('2023-11-08 18:00:00')
    date_four = QPushButton('2023-11-08 21:00:00')
    date_five = QPushButton('2023-11-09 00:00:00')
    date_six = QPushButton('2023-11-09 03:00:00')
    ...
    date_time_one = QDateTime(QDate(2023, 11, 8), QTime(12, 00, 00))
    date_time_two = QDateTime(QDate(2023, 11, 8), QTime(15, 00, 00))
    date_time_three = QDateTime(QDate(2023, 11, 8), QTime(18, 00, 00))
    date_time_four = QDateTime(QDate(2023, 11, 8), QTime(21, 00, 00))
    date_time_five = QDateTime(QDate(2023, 11, 9), QTime(00, 00, 00))
    date_time_six = QDateTime(QDate(2023, 11, 9), QTime(3, 00, 00))
